...
async def check_connection_pool():
    ...
    try:
        ...
        engine = get_engine()
        if engine is None:
            return {"status": "unhealthy", "connection_pool": "not_initialized"}
        ...
        return {"status": "healthy", "connection_pool": "active", "test_result": test_result}
    except Exception as e:
        return {"status": "unhealthy", "connection_pool": "error", "error": str(e)}
