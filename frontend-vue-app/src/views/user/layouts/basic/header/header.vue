  ...
  >
    <slot :name="slot.name">
      <template v-if="slot.name === 'refresh'">
        <ZayumIconButton class="my-0 mr-1 rounded-md" @click="refresh">
    ...
    <template v-for="slot in rightSlots" :key="slot.name">
      <slot :name="slot.name">
        ...
        <template v-else-if="slot.name === 'fullscreen'">
          <ZayumFullScreen class="mr-1" />
        </template>

        <!-- New Button to Open Homepage in a New Window -->
        <template v-else-if="slot.name === 'homepage-button'">
          <ZayumIconButton
            class="mr-1"
            @click="openHomepage"
          >
