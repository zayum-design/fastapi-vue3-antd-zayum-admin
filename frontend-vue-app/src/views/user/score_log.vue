<template>
  <div>
    ...
    >
      ...
      >
        <a-form-item :label="$t('user.score_log.field.id')">
          <a-input v-model:value="currentItem.id" :disabled="true" />
        </a-form-item>

        <a-form-item :label="$t('user.score_log.field.score')">
          <a-input v-model:value="currentItem.score" :disabled="true" />
        </a-form-item>

        <a-form-item :label="$t('user.score_log.field.before')">
          <a-input v-model:value="currentItem.before" :disabled="true" />
        </a-form-item>

        <a-form-item :label="$t('user.score_log.field.after')">
        ...
        <a-form-item :label="$t('user.score_log.field.created_at')">
          <a-input v-model:value="currentItem.created_at" :disabled="true" />
        </a-form-item>

        <a-form-item :label="$t('user.score_log.field.updated_at')">
