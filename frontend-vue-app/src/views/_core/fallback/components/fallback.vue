...
import { ArrowLeft, RotateCw } from '@/_core/ui/icons/icons';
...
const props = withDefaults(defineProps<Props>(), {
  description: '',
  homePath: '/admin/dashboard/workspace',
  image: '',
  showBack: true,
  status: 'coming-soon',
  title: '',
...
<template>
  <div class="flex size-full flex-col items-center justify-center duration-300">
    ...
    <div class="flex-col-center">
      ...
      <ZayumButton v-else-if="showBack" size="lg" @click="back">
        <ArrowLeft class="mr-2 size-4" />
        {{ $t('common.back_to_home') }}
      </ZayumButton>
      <ZayumButton v-else-if="showRefresh" size="lg" @click="refresh">
