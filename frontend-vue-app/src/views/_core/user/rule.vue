...
const columns = computed(() => [
  ...
  { 
    title: $t('user.rule.field.rule_type'), 
    dataIndex: 'rule_type', 
    key: 'rule_type',
    sorter: true,
    sortDirections: ['ascend', 'descend'],
  ...
  { 
    title: $t('user.rule.field.status'), 
    dataIndex: 'status', 
    key: 'status',
    sorter: true,
    sortDirections: ['ascend', 'descend'],
