...
import { useForwardPropsEmits } from '@/_core/composables';
import { ChevronLeft, ChevronRight } from '@/_core/ui/icons';
import { ZayumScrollbar } from '@/_core/ui/common-ui/shadcn-ui';
