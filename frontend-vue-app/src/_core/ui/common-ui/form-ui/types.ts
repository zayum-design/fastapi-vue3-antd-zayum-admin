...
import type { ZayumButtonProps } from '@/_core/ui/common-ui/shadcn-ui';
import type { ClassType, MaybeComputedRef } from '@/_core/typings';
...
export interface ActionButtonOptions extends ZayumButtonProps {
  [key: string]: any;
  content?: MaybeComputedRef<string>;
  show?: boolean;
}

export interface ZayumFormProps<
  T extends BaseFormComponentType = BaseFormComponentType,
> extends Omit<
    FormRenderProps<T>,
...
export type ExtendedFormApi = FormApi & {
  useStore: <T = NoInfer<ZayumFormProps>>(
    selector?: (state: NoInfer<ZayumFormProps>) => T,
  ) => Readonly<Ref<T>>;
};

export interface ZayumFormAdapterOptions<
  T extends BaseFormComponentType = BaseFormComponentType,
> {
  config?: {
