...
import { LockKeyhole } from '@/_core/ui/icons';
import { $t, useI18n } from '@/locales';
import { storeToRefs, useLockStore } from '@/stores';

import { useScrollLock } from '@/_core/composables';
...
const [Form, { form, validate }] = useZayumForm(
  reactive({
    commonConfig: {
      hideLabel: true,
    ...
    <transition name="slide-right">
      ...
      >
        <div class="flex-col-center mb-10 w-[300px]">
          <ZayumAvatar :src="avatar" class="enter-x mb-6 size-20" />

          <div class="enter-x mb-2 w-full items-center">
            <Form />
          </div>
          <ZayumButton class="enter-x w-full" @click="handleSubmit">
