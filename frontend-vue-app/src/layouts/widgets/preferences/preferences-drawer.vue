...
import type { SegmentedItem } from '@/_core/ui/common-ui/shadcn-ui';

import { computed, ref } from 'vue';

import { Copy, RotateCw } from '@/_core/ui/icons';
...
<template>
  <div>
    ...
    >
      ...
      <div class="p-1">
        <ZayumSegmented v-model="activeTab" :tabs="tabs">
          <template #general>
