...
import { Bell, MailCheck } from '@/_core/ui/icons';
  ...
  >
    <template #trigger>
      <div class="flex-center mr-2 h-full" @click.stop="toggle()">
        <ZayumIconButton class="bell-button text-foreground relative">
          <span
            v-if="dot"
    ...
    <div class="relative">
      ...
      <ZayumScrollbar v-if="notifications.length > 0">
      ...
      >
        ...
        <ZayumButton size="sm" @click="handleViewAll">
