...
import type { TabDefinition } from '@/_core/types';

import type { IContextMenuItem } from '@/_core/ui/common-ui/tabs-ui';

import { computed, ref, watch } from 'vue';
import { useRoute, useRouter } from 'vue-router';

import { useContentMaximize, useTabs } from '@/_core/hooks';
import {
  ArrowLeftToLine,
  ArrowRightLeft,
  ArrowRightToLine,
