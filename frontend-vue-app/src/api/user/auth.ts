...
export async function loginApi(data: UserAuthApi.LoginParams) {
  return userRequestClient.post<UserAuthApi.LoginResult>(
    "/user/auth/login",
    data,
  );
}
...
export async function forgotPasswordApi(
  data: UserAuthApi.ForgotPasswordParams,
) {
...
export async function saveProfileApi(data: any) {
  return userRequestClient.post<UserInfo>("/user/auth/profile", data);
}
...
export async function refreshTokenApi() {
  return userBaseRequestClient.post<{ data: string }>(
