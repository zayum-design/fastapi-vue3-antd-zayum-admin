...
export let useTableForm: typeof useZayumForm;
...
export function setupZayumVxeTable(setupOptions: SetupVxeTable) {
  const { configVxeTable, useZayumForm } = setupOptions;

  initVxeTable();
  useTableForm = useZayumForm;
